    ...
    */
    ...
    _preprocessSlideData: function (slidesDataList) {
        slidesDataList.forEach(function (slideData, index) {
            ...
            }  else if (slideData.category === 'local_external' && slideData.videoSourceType === 'clapprvideo'){
                slideData.src = slideData.embedCode;
                slideData.embedUrl =  slideData.src;
                slideData.embedCode = '<div id="clappr_' + slideData.id + '" class="clapprVideo"></div>';
                slideData.external_url = slideData.embedCode;
            } else if (slideData.category === 'local_external' && slideData.videoSourceType === 'localvideo'){
    ...
    _renderSlide: function () {
        ...
        } else if (slide.category === 'local_external' && slide.videoSourceType === 'clapprvideo'){
        ...
        } else if (slide.category === 'local_external' && slide.videoSourceType === 'localvideo'){
            $content.append(slide.embedCode);
        }
